...
# Activate "MLIP_oldFC" conda environment to use this program

# create conda; python3 -m pip install fairchem-core==1.10; 
...
if constraint_input.lower() == 'yes':
    ...
    # with open(f"{mlip_name}/constraints.log", "w") as f:
